  ...
  return (
    ...
    >
      <main className="mx-auto max-w-5xl px-4">
        {/* Toolbar */}
        <div className="print:hidden sticky top-0 z-40 -mx-4 mb-4 rounded-xl border border-gray-200 bg-white/90 px-4 py-2 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-gray-700 dark:bg-gray-900/80">
